            ...
            <div class="data_list">
                ...
                <div class="datas">
                    <ul>
                        ...
                        <li><span><a href="${pageContext.request.contextPath}/rss.xml" type="application/rss+xml" target="blank"><img src="${pageContext.request.contextPath}/images/rss.gif"/></a>
                       </span> </li>
<%--                        <li><span><a href="rss.xml" type="application/rss+xml" target="blank">更新rss</a>--%>
<%--                        </span></li>--%>
                    </ul>
                </div>
            </div>
